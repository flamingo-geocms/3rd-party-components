...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="fo">
  ...
  <xsl:template name="dbk_titleBk">
    ...
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="6.15cm" height="7.36cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block-border">
  ...
  <xsl:template name="dbk_specialBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="6.15cm" height="7.36cm" top="0cm" left="6.25cm" xsl:use-attribute-sets="column-block-border">
        <!-- Bijzonderheden.-->
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Bijzonderheden</fo:block>
        <fo:block margin-top="0.2cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="5.95cm">
            <fo:table-column column-width="1.785cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="4.165cm"></fo:table-column>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
                  <fo:block>
        ...
        <!-- Verblijf.-->
        <fo:block margin-top="0.2cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Verblijf</fo:block>
        <fo:block margin-top="0.2cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="5.95cm">
            <fo:table-column column-width="1.309cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.892cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.773cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.773cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.535cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.238cm"></fo:table-column>
            <fo:table-column column-width="0.238cm"></fo:table-column>
            <fo:table-column column-width="0.238cm"></fo:table-column>
            <fo:table-column column-width="0.238cm"></fo:table-column>
            <fo:table-column column-width="0.238cm"></fo:table-column>
      ...
      <xsl:for-each select="foto">
        <xsl:if test="*">
          <xsl:if test="position()=1">
            <xsl:if test=".!='null'">
              <fo:block-container width="6.15cm" height="5.52cm" top="7.46cm" left="0cm" xsl:use-attribute-sets="column-block-border">
      ...
      <xsl:for-each select="foto">
        <xsl:if test="*">
          <xsl:if test="position()=2">
            <xsl:if test=".!='null'">
              <fo:block-container width="6.15cm" height="5.52cm" top="7.46cm" left="6.25cm" xsl:use-attribute-sets="column-block-border">
                <fo:block margin="0.05cm">
                  <xsl:variable name="photoUrl" select="URL"></xsl:variable>
                  <fo:external-graphic src="{$photoUrl}" width="100%" height="100%" content-width="scale-to-fit"></fo:external-graphic>
                </fo:block>
  ...
  <xsl:template name="dbk_dangerousSubstBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="12.4cm" height="5.52cm" top="13.08cm" left="0cm" xsl:use-attribute-sets="column-block-border">
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Gevaarlijke stoffen</fo:block>
        <fo:block margin-top="0.2cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="12.2cm">
            <fo:table-column column-width="2.025cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.025cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.025cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.025cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.025cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.025cm"></fo:table-column>
            <fo:table-body>
              <!-- Header.-->
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
  ...
  <xsl:template name="dbk_mapBk">
    ...
    <fo:block-container width="12.4cm" height="18.6cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block">
  ...
  <xsl:template name="dbk_mapInfoBk">
    ...
    <fo:block-container width="8cm" height="3.6cm" top="15cm" left="4.4cm" xsl:use-attribute-sets="column-block">
  ...
  <xsl:variable name="map-width-px" select="'351'"></xsl:variable>
  <xsl:variable name="map-height-px" select="'527'"></xsl:variable>
  <!-- Formatter.-->
  ...
  <xsl:template name="layout-master-set">
    <fo:layout-master-set>
      <fo:simple-page-master master-name="dbk_page" page-height="21cm" page-width="14.8cm" margin-top="1.2cm" margin-bottom="1.2cm" margin-left="1.2cm" margin-right="1.2cm">
