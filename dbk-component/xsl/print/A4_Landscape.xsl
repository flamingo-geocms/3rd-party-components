...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="fo">
  ...
  <xsl:template name="dbk_titleBk">
    ...
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="7.046cm" height="9.435cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block-border">
        ...
        <fo:block margin-top="0.05cm" margin-left="0.2cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="6.646cm">
            <fo:table-column column-width="1.993cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.658cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="1.993cm"></fo:table-column>
            <fo:table-body>
              <!-- Header.-->
              <fo:table-row>
  ...
  <xsl:template name="dbk_specialBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="7.046cm" height="9.065cm" top="9.535cm" left="0cm" xsl:use-attribute-sets="column-block-border">
        <!-- Bijzonderheden.-->
        <fo:block margin-top="0.1cm" margin-left="0.2cm" xsl:use-attribute-sets="title-font">Bijzonderheden</fo:block>
        <fo:block margin-top="0.2cm" margin-left="0.2cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="6.646cm">
            <fo:table-column column-width="1.993cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="4.652cm"></fo:table-column>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
                  <fo:block>
        ...
        <fo:block margin-top="0.2cm" margin-left="0.2cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="6.646cm">
            <fo:table-column column-width="1.462cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.996cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.863cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.863cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.598cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.265cm"></fo:table-column>
            <fo:table-column column-width="0.265cm"></fo:table-column>
            <fo:table-column column-width="0.265cm"></fo:table-column>
            <fo:table-column column-width="0.265cm"></fo:table-column>
            <fo:table-column column-width="0.265cm"></fo:table-column>
      ...
      <xsl:for-each select="foto">
        <xsl:if test="*">
          <xsl:if test="position()=1">
            <xsl:if test=".!='null'">
              <fo:block-container width="10.027cm" height="9.435cm" top="0cm" left="7.146cm" xsl:use-attribute-sets="column-block-border">
      ...
      <xsl:for-each select="foto">
        <xsl:if test="*">
          <xsl:if test="position()=2">
            <xsl:if test=".!='null'">
              <fo:block-container width="10.027cm" height="9.435cm" top="0cm" left="17.273cm" xsl:use-attribute-sets="column-block-border">
                <fo:block margin="0.05cm">
                  <xsl:variable name="photoUrl" select="URL"></xsl:variable>
                  <fo:external-graphic src="{$photoUrl}" width="100%" height="100%" content-width="scale-to-fit"></fo:external-graphic>
                </fo:block>
  ...
  <xsl:template name="dbk_dangerousSubstBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="20.154cm" height="9.065cm" top="9.535cm" left="7.146cm" xsl:use-attribute-sets="column-block-border">
        <fo:block margin-top="0.1cm" margin-left="0.2cm" xsl:use-attribute-sets="title-font">Gevaarlijke stoffen</fo:block>
        <fo:block margin-top="0.2cm" margin-left="0.2cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="19.754cm">
            <fo:table-column column-width="3.279cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="3.279cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="3.279cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="3.279cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="3.279cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="3.279cm"></fo:table-column>
            <fo:table-body>
              <!-- Header.-->
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
  ...
  <xsl:template name="dbk_mapBk">
    ...
    <fo:block-container width="27.3cm" height="18.6cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block">
  ...
  <xsl:template name="dbk_mapInfoBk">
    ...
    <fo:block-container width="8cm" height="3.6cm" top="15cm" left="19.3cm" xsl:use-attribute-sets="column-block">
  ...
  <xsl:include href="styles_a4.xsl"></xsl:include>
  <!-- Parameters.-->
  ...
  <xsl:template name="layout-master-set">
    <fo:layout-master-set>
      <fo:simple-page-master master-name="dbk_page" page-height="21cm" page-width="29.7cm" margin-top="1.2cm" margin-bottom="1.2cm" margin-left="1.2cm" margin-right="1.2cm">
