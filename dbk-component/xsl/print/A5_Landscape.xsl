...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="fo">
  ...
  <xsl:template name="dbk_titleBk">
    ...
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="4.784000000000001cm" height="6.273cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block-border">
        <fo:block margin-top="0.05cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Digitale bereikbaarheidskaart</fo:block>
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <xsl:choose>
        ...
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">Datum afdruk:
        ...
        <!-- Algemeen.-->
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Algemeen</fo:block>
        ...
        <!-- Gebouwinformatie.-->
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Gebouwinformatie</fo:block>
        ...
        <!-- Adres.-->
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Adres</fo:block>
        ...
        <!-- Contact.-->
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Contact</fo:block>
        <fo:block margin-top="0.025cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="4.584cm">
            <fo:table-column column-width="1.375cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="1.833cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="1.375cm"></fo:table-column>
            <fo:table-body>
              <!-- Header.-->
              <fo:table-row>
  ...
  <xsl:template name="dbk_specialBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="4.784cm" height="6.027cm" top="6.373cm" left="0cm" xsl:use-attribute-sets="column-block-border">
        <!-- Bijzonderheden.-->
        <fo:block margin-top="0.05cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Bijzonderheden</fo:block>
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="4.584cm">
            <fo:table-column column-width="1.375cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="3.208cm"></fo:table-column>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
                  <fo:block>
        ...
        <!-- Verblijf.-->
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Verblijf</fo:block>
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="4.584cm">
            <fo:table-column column-width="1.008cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.687cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.595cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.595cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.412cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.183cm"></fo:table-column>
            <fo:table-column column-width="0.183cm"></fo:table-column>
            <fo:table-column column-width="0.183cm"></fo:table-column>
            <fo:table-column column-width="0.183cm"></fo:table-column>
            <fo:table-column column-width="0.183cm"></fo:table-column>
      ...
      <xsl:for-each select="foto">
        <xsl:if test="*">
          <xsl:if test="position()=1">
            <xsl:if test=".!='null'">
              <fo:block-container width="6.808cm" height="6.273cm" top="0cm" left="4.884cm" xsl:use-attribute-sets="column-block-border">
      ...
      <xsl:for-each select="foto">
        <xsl:if test="*">
          <xsl:if test="position()=2">
            <xsl:if test=".!='null'">
              <fo:block-container width="6.808cm" height="6.273cm" top="0cm" left="11.792cm" xsl:use-attribute-sets="column-block-border">
                <fo:block margin="0.05cm">
                  <xsl:variable name="photoUrl" select="URL"></xsl:variable>
                  <fo:external-graphic src="{$photoUrl}" width="100%" height="100%" content-width="scale-to-fit"></fo:external-graphic>
                </fo:block>
  ...
  <xsl:template name="dbk_dangerousSubstBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="13.716cm" height="6.027cm" top="6.373cm" left="4.884cm" xsl:use-attribute-sets="column-block-border">
        <fo:block margin-top="0.05cm" margin-left="0.1cm" xsl:use-attribute-sets="title-font">Gevaarlijke stoffen</fo:block>
        <fo:block margin-top="0.1cm" margin-left="0.1cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="13.516cm">
            <fo:table-column column-width="2.243cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.243cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.243cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.243cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.243cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.243cm"></fo:table-column>
            <fo:table-body>
              <!-- Header.-->
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
  ...
  <xsl:template name="dbk_mapBk">
    ...
    <fo:block-container width="18.6cm" height="12.4cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block">
  ...
  <xsl:template name="dbk_mapInfoBk">
    ...
    <fo:block-container width="8cm" height="3.6cm" top="8.8cm" left="10.6cm" xsl:use-attribute-sets="column-block">
      <!-- Map Info Graphics Block.-->
      <fo:block-container width="2.747cm" height="3.5cm" top="0.05cm" left="0.05cm" xsl:use-attribute-sets="column-block">
        <!-- Map North Arrow Block.-->
        <fo:block-container width="2.747cm" height="2.89cm" top="0cm" left="0cm" background-color="white" xsl:use-attribute-sets="column-block">
          <xsl:call-template name="windrose">
            <xsl:with-param name="angle" select="angle"></xsl:with-param>
            <xsl:with-param name="width" select="'2.546cm'"></xsl:with-param>
            <xsl:with-param name="height" select="'2.69cm'"></xsl:with-param>
            <xsl:with-param name="top" select="'0.1cm'"></xsl:with-param>
            <xsl:with-param name="left" select="'0.1cm'"></xsl:with-param>
          </xsl:call-template>
        </fo:block-container>
        <!-- Map Scale Block.-->
        <fo:block-container width="2.747cm" height="0.56cm" top="2.94cm" left="0cm" background-color="white" xsl:use-attribute-sets="column-block">
      ...
      <!-- Map Info Text Block.-->
      <fo:block-container width="5.102cm" height="3.5cm" top="0.05cm" left="2.847cm" xsl:use-attribute-sets="column-block">
        <!-- Map Info Text Header Block.-->
        <fo:block-container width="5.102cm" height="1.059cm" top="0cm" left="0cm" background-color="white" xsl:use-attribute-sets="column-block">
        ...
        <fo:block-container width="5.102cm" height="0.56cm" top="1.109cm" left="0cm" background-color="white" xsl:use-attribute-sets="column-block">
          <fo:block margin-top="0.15cm" margin-left="0.2cm" xsl:use-attribute-sets="mapinfo-font">
            <xsl:choose>
        ...
        <fo:block-container width="5.102cm" height="0.56cm" top="1.719cm" left="0cm" background-color="white" xsl:use-attribute-sets="column-block">
          <fo:block margin-top="0.15cm" margin-left="0.2cm" xsl:use-attribute-sets="mapinfo-font">
            <xsl:choose>
        ...
        <fo:block-container width="5.102cm" height="0.56cm" top="2.329cm" left="0cm" background-color="white" xsl:use-attribute-sets="column-block">
          <fo:block margin-top="0.15cm" margin-left="0.2cm" xsl:use-attribute-sets="mapinfo-font">
        ...
        <fo:block-container width="5.102cm" height="0.56cm" top="2.939cm" left="0cm" background-color="white" xsl:use-attribute-sets="column-block">
  ...
  <xsl:include href="styles_a5.xsl"></xsl:include>
  <!-- Parameters.-->
  <xsl:param name="versionParam" select="'1.0'"></xsl:param>
  <xsl:variable name="map-width-px" select="'527'"></xsl:variable>
  <xsl:variable name="map-height-px" select="'351'"></xsl:variable>
  <!-- Formatter.-->
  ...
  <xsl:template name="layout-master-set">
    <fo:layout-master-set>
      <fo:simple-page-master master-name="dbk_page" page-height="14.8cm" page-width="21cm" margin-top="1.2cm" margin-bottom="1.2cm" margin-left="1.2cm" margin-right="1.2cm">
