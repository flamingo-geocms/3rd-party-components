...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="fo">
  ...
  <xsl:template name="dbk_titleBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="9.25cm" height="8.943cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block-border">
        ...
        <fo:block margin-top="0.05cm" margin-left="0.2cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="8.85cm">
            <fo:table-column column-width="2.655cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="3.54cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="2.655cm"></fo:table-column>
            <fo:table-body>
              <!-- Header.-->
              <fo:table-row>
  ...
  <xsl:template name="dbk_specialBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="9.25cm" height="8.943cm" top="0cm" left="9.35cm" xsl:use-attribute-sets="column-block-border">
        <!-- Bijzonderheden.-->
        <fo:block margin-top="0.1cm" margin-left="0.2cm" xsl:use-attribute-sets="title-font">Bijzonderheden</fo:block>
        <fo:block margin-top="0.2cm" margin-left="0.2cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="8.85cm">
            <fo:table-column column-width="2.655cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="6.194cm"></fo:table-column>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
        ...
        <fo:block margin-top="0.2cm" margin-left="0.2cm" xsl:use-attribute-sets="default-font">
          <fo:table table-layout="fixed" width="8.85cm">
            <fo:table-column column-width="3.54cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.885cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="1.77cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="1.77cm" border-width="thin" border-right-style="solid"></fo:table-column>
            <fo:table-column column-width="0.885cm"></fo:table-column>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell margin-left="0.05cm">
    ...
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <xsl:for-each select="foto">
        <xsl:if test="position()=1">
          <fo:block-container width="9.25cm" height="8.943cm" top="9.043cm" left="0cm" xsl:use-attribute-sets="column-block-border">
    ...
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <xsl:for-each select="foto">
        <xsl:if test="position()=2">
          <fo:block-container width="9.25cm" height="8.943cm" top="9.043cm" left="9.35cm" xsl:use-attribute-sets="column-block-border">
            <fo:block margin="0.05cm">
              <xsl:variable name="photoUrl" select="URL"></xsl:variable>
              <fo:external-graphic src="{$photoUrl}" width="100%" height="100%" content-width="scale-to-fit"></fo:external-graphic>
            </fo:block>
  ...
  <xsl:template name="dbk_dangerousSubstBk">
    <xsl:for-each select="extra/info[@classname='viewer.components.Dbk']/root">
      <fo:block-container width="18.6cm" height="8.943cm" top="18.086cm" left="0cm" xsl:use-attribute-sets="column-block-border">
  ...
  <xsl:template name="dbk_mapBk">
    ...
    <fo:block-container width="18.6cm" height="27.3cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block">
  ...
  <xsl:template name="dbk_mapInfoBk">
    <fo:block-container width="8cm" height="3.6cm" top="23.7cm" left="10.6cm" xsl:use-attribute-sets="column-block">
  ...
  <xsl:template name="layout-master-set">
    <fo:layout-master-set>
      <fo:simple-page-master master-name="dbk_page" page-height="29.7cm" page-width="21cm" margin-top="1.2cm" margin-bottom="1.2cm" margin-left="1.2cm" margin-right="1.2cm">
